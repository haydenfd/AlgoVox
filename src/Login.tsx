    ...
    <div className="flex items-center justify-center min-h-screen bg-[#0a0a10] p-5">
      <div className="w-full max-w-[400px] text-center">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* GitHub OAuth - Commented out until setup is complete
          <button
            className="w-full flex items-center justify-center gap-3 px-6 py-3.5 bg-[#24292e] text-white border border-[#2a2a38] rounded-[10px] text-base font-medium hover:bg-[#2f363d] hover:border-[#3e3e42] hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
